        ...
        <div className='border-b border-b-gray-300'>
            <div className='max-w-[90%] space-y-4 lg:space-y-0 lg:max-w-[80%] mx-auto flex flex-col lg:flex-row justify-between items-center py-4'>
                ...
                <div className='flex items-center gap-4'>
                    <h2 className='text-xl relative'><LuShoppingCart /> <span className='absolute -top-3 -right-3 bg-red-500 text-xs rounded-full py-0.5 px-2 text-white font-semibold'>{info.length}</span></h2>
